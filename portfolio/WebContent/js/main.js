...
(function() {
																...
																setTimeout(
																		function() {
																			...
																			if (effect === 'fadeIn') {
																				...
																				el
																						.addClass('fadeInUp animated-fast');
																			}
	...
	var dropdown = function() {
		...
		$('.has-dropdown').mouseenter(
				function() {

					var $this = $(this);
					$this.find('.dropdown').css('display', 'block').addClass(
							'animated-fast fadeInUpMenu');

				}).mouseleave(
				function() {
					var $this = $(this);

					$this.find('.dropdown').css('display', 'none').removeClass(
							'animated-fast fadeInUpMenu');
				});
...
$(window).scroll(function(e) {
	if ($(this).scrollTop() >= 576) {
		$(".container").addClass("container_scrolled")
	} else {
		$(".container").removeClass("container_scrolled")
	}
})
});
